/**
 * Drizzle ORM Schema Definition for MariaDB
 *
 * This file defines the database schema using Drizzle ORM's type-safe schema builder
 * for MySQL/MariaDB dialect. Types are automatically inferred from the schema.
 *
 ...
 */
export const testRecords = mysqlTable(
  'test_records',
  {
 ...
 */
export const fileMetadata = mysqlTable(
  'file_metadata',
  {
    id: int('id').primaryKey().autoincrement(),
